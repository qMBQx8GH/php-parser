...
var _ Vertex = &StmtPropertyHook{}

func (n *StmtPropertyHook) Accept(v Visitor) {
	v.StmtPropertyHook(n)
}

func (n *StmtPropertyHook) GetPosition() *position.Position {
	return n.Position
}

func (n *StmtPropertyHook) GetType() Type {
	return TypeStmtPropertyHook
}
